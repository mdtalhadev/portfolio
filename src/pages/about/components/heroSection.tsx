...
const AboutHeroSec = () => {
    return (
        <section className="relative my-10">
                <div className="px-8 w-full items-center flex justify-between flex-col sm:flex-row md:flex-row lg:flex-row xl:flex-row bg-white p-2 rounded-md shadow-md ">
                    <div className="flex flex-col items-center sm:items-start md:items-start lg:items-start xl:items-start pr-8">
                    ...
                    <Image src="/images/aboutMe.png" alt="About" width={400} height={400} />
                </div>
