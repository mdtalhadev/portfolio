...
const AppBar = () => {
  const downloadFile = () => {
    ...
    const filePath = '/Muhammad-Talha.pdf';

    // Create an anchor element and trigger the download
    const link = document.createElement('a');
    link.href = filePath;
    link.setAttribute('download', 'Muhammad Talha CV.pdf'); // Optional: set a custom filename for download
    ...
    <nav className="bg-gray-800 text-white py-4">
      <div className="container mx-auto px-4 flex justify-between">
        <div>
          <a
            href="#"
            className="text-xl md:text-2xl lg:text-2xl xl:text-2xl  font-bold"
          >
            🚀 My Quickly Portfolio 🎨
          </a>
